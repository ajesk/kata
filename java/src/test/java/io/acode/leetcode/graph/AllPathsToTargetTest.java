...
public class AllPathsToTargetTest {
  AllPathsToTarget target = new AllPathsToTarget();
  ...
  public void testThreeNodesTwoPaths() {
    assertEquals(List.of(List.of(0, 1, 2), List.of(0, 2)), target.allPathsSourceTarget(new int[][]{{1, 2}, {2}, {}}));
  }
